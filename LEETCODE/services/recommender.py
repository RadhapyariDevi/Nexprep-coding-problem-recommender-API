...
from LEETCODE.services.database_cache import get_problem, get_problems_by_tag_local
...
async def generate_recommendations(username: str, top_k: int = 10) -> dict:
    ...
    try:
        ...
        print(f"mastery_vector built: {len(mastery_vector)} topics")
        ...
        candidate_fetch = [
            get_problems_by_tag_local(tag, target_difficulty, limit=20)
